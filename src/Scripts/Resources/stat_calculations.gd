...
func calculate_minimum_weapon_attack_damage() -> void:
...
func calculate_maximum_magic_attack_damage() -> void:
...
func calculate_shadow_attack_damage(is_max: bool) -> int:
...
func calculate_minimum_shadow_attack_damage() -> void:
	var value = calculate_shadow_attack_damage(false)
	stats_resource.set_min_shadow_attack(value) 

# Function to calculate maximum shadow attack damage
func calculate_max_shadow_attack_damage() -> void:
	stats_resource.set_max_shadow_attack(calculate_shadow_attack_damage(true)) 
...
func init_necessary_stat_calculations() -> void:
	calculate_minimum_weapon_attack_damage()
	calculate_maximum_weapon_attack_damage()
	calculate_minimum_magic_attack_damage()
	calculate_maximum_magic_attack_damage()
	calculate_minimum_shadow_attack_damage()
	calculate_max_shadow_attack_damage()
