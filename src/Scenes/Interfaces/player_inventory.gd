...
@onready var weapons_tab_button : Button = $HBoxContainer/SideBar/ButtonContainer/WeaponsTabButton
@onready var recipes_tab_button : Button = $HBoxContainer/SideBar/ButtonContainer/RecipesTabButton
@onready var accessories_tab_button : Button = $HBoxContainer/SideBar/ButtonContainer/AccessoriesTabButton
@onready var drip_tab_button : Button = $HBoxContainer/SideBar/ButtonContainer/DripTabButton
@onready var consumables_tab_button : Button = $HBoxContainer/SideBar/ButtonContainer/ConsumablesTabButton
@onready var materials_tab_button : Button = $HBoxContainer/SideBar/ButtonContainer/MaterialsTabButton
